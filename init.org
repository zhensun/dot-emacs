...
Windows version has problem connecting to Maramlaba Repos, we will use
melpa as main source. On other systems we will use Maramlaba and
melpa-stable instead.
